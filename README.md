...
```console
conda env create -f doc-build.yml
conda activate aiida-archive-demo-docs
```
...
[binder-link]: https://mybinder.org/v2/gh/chrisjsewell/aiida-archive-demo/main?filepath=docs/index.md
